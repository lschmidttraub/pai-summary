...
\textbf{H-UCRL}: \\$\pi_{t+1}=\argmax_\pi \max_{\eta(\cdot)\in[-1,1]^d} J_H(\pi;\hat f_t)$ with 
...
Assuming a family of plausible models $\mathcal M(\mathcal D)$, we can be \textbf{optimistic} w.r.t. rewards and \textbf{pessimistic} w.r.t. constraints.\\
