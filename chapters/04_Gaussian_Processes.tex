...
\begin{framed}
    ...
    Write $\mK_{\vy,\vtheta} \defeq \mK_{f,\vtheta} + \sigman^2 \mI$, and obtain: $\vthetahat_\MLE = \argmin_{\vtheta} \frac{1}{2} \transpose{\vy} \inv{\mK_{\vy,\vtheta}} \vy + \frac{1}{2} \log \det{\mK_{\vy,\vtheta}}$. \\
\end{framed}
$\frac{\partial}{\partial \theta_j} \log p(y \mid X, \theta) = \frac{1}{2} \text{tr} \left( \left( \alpha \alpha^T - \mK_{\vy,\vtheta}^{-1} \right) \frac{\partial \mK_{\vy,\vtheta}}{\partial \theta_j} \right), \alpha=\mK_{\vy,\vtheta}^{-1}y$
